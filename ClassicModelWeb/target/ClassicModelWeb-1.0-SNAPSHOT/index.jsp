    ...
    <script>
        function loadOffice(officeCode) {
            ...
            xhttp.onload = function () {
                setLoading('off');
                if (xhttp.status == 200) {
                    document.getElementById("body-content").innerHTML = xhttp.responseText; // replace content in this div
                } else {
                    showLoginForm();
                }
            }
        ...
        //     let loading = document.getElementById("body-content");
        //     if (status == 'on') {
        //         loading.innerHTML = `<div class="position-absolute top-50 start-50 translate-middle"><img src="./assets/images/Spin-1s-200px.svg"></div>`;
        //     }
        // }
